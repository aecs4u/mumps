!
! Dense BLAS benchmark for DGEMM.
...
program dgemm_bench
  ...
  real(8) :: alpha, beta, t0, t1, seconds, gflops
  ...
  write(*,'(a,i0)') 'DGEMM_BENCH_M=', m
  write(*,'(a,i0)') 'DGEMM_BENCH_N=', n
  write(*,'(a,i0)') 'DGEMM_BENCH_K=', k
  write(*,'(a,i0)') 'DGEMM_BENCH_ITERS=', iters
  write(*,'(a,f0.6)') 'DGEMM_BENCH_SECONDS=', seconds
  write(*,'(a,f0.3)') 'DGEMM_BENCH_GFLOPS=', gflops
...
subroutine print_usage()
  implicit none
  write(*,'(a)') 'Usage: ./dgemm_bench [--m M] [--n N] [--k K] [--iters I]'
