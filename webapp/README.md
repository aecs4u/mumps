...
- 🗄️ **SQLite database** with TSV fallback
- 🔢 **Multi-precision support** (s/d/c/z)
- 📈 **Ordering library comparison** (PORD, METIS, SCOTCH, AMD, etc.)
- 🌐 **JSON API** for programmatic access
- ⚡ **Fast filtering** by precision and ordering method
...
- `BLAS_BENCH_DB`: SQLite database path (default: `benchmarks/results/blas_benchmarks.sqlite`)
...
1. **SQLite database** (preferred): `benchmarks/results/blas_benchmarks.sqlite`
